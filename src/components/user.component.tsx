            ...
            <Disclosure.Button className="py-2 w-full">
              <div className="px-4 py-5 sm:px-6 flex flex-col sm:flex-row items-center w-full">
                ...
                <div className="flex flex-col flex-1 items-start">
                  <div className="text-md font-bold text-blue-500 focus:outline-none flex justify-between items-center w-full">
...
export const User = ({
  ...
  return (
    <div className="bg-white shadow-2xl overflow-hidden rounded-lg my-4 mx-2 sm:mx-0">
      <Disclosure>
        {({ open }) => {
            ...
            <>
              <Disclosure.Button className="py-2 w-full">
                <div className="px-4 py-5 sm:px-6 flex flex-col sm:flex-row items-center w-full">
                  ...
                  <div className="flex flex-col flex-1 items-start">
                    <button
                      className="text-md font-bold text-blue-500 focus:outline-none flex justify-between items-center w-full"
                    ...
                    <p>
                      ...
                      >
                        <LinkIcon className="h-4 w-4 inline" /> View on Github
                      </a>
                    </p>
